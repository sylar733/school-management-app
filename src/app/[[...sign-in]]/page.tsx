...
export default function SignInPage() {
  ...
  useEffect(() => {
    if (isLoaded && isSignedIn && user) {
      // Assume that the user's role is stored in publicMetadata.role.
      // Adjust this as needed based on how you store the role.
      const userRole = user.publicMetadata.role;
      if (userRole) {
        // Redirect to the corresponding path (e.g., '/admin', '/teacher', '/student', or '/parent')
        router.push(`/${userRole}`);
      } else {
        // Fallback in case no role is set
        router.push('/');
      }
    }
